...
\textbf{Part (a).} I chose an article from the \textit{American Journal of Sociology}.
\textbf{Part (b).} O'Brien, Rourke L. "Redistribution and the New Fiscal Sociology: Race and the Progressivity of State and Local Taxes." \textit{American Journal of Sociology} 122, no 4 (2017). 1015-1049.
\textbf{Part (c).}
\textbf{Part (d).}
\textbf{Part (e).}
\textbf{Part (f).}
